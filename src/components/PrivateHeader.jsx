...
function PrivateHeader() {
  return (
    <div className="flex items-center gap-8 px-4 py-3 border-b shadow">
      <div>
        <Logo />
      </div>
      <div className="flex items-center justify-between flex-1 px-1 py-1 bg-gray-100 rounded-full">
        <Link
          className="px-4 py-2 text-sm text-white rounded-full bg-brand-blue"
          to="/learn"
        >
          Home
        </Link>
      ...
      <div className="flex items-center justify-between px-1 py-1 bg-gray-100 rounded-full">
        <Link
          className="flex items-center gap-2 px-4 py-2 text-sm rounded-full hover:bg-gray-200"
          to="/learn"
        >
      ...
      <div>
        <div className="flex items-center flex-1 gap-2 px-4 py-2 border-2 rounded-full">
      ...
      <div className="flex items-center gap-4">
        <Link
          to="/plans"
          className="px-3 py-2 text-sm text-white rounded bg-brand-purple"
        >
          Upgrade
        </Link>
